...
void loop() {
  ...
  displayChar('H'); delay(1000);
  displayChar('A'); delay(1000);
  displayChar('L'); delay(1000);
  displayChar('O'); delay(1000);
}
...
void charH(){
  digitalWrite(segF, LOW); digitalWrite(segE, LOW); digitalWrite(segG, LOW);
  digitalWrite(segB, LOW); digitalWrite(segC, LOW); 
}
...
void charL(){
  digitalWrite(segF, LOW); digitalWrite(segE, LOW); digitalWrite(segD, LOW);
}
